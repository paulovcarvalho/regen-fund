            ...
            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        className: "w-full text-white relative px-2 flex items-center justify-between lg:w-auto lg:static lg:block lg:justify-start font-Cormorant text-2xl",
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("ul", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                                        className: router.pathname == "/invesdedIn" ? "rounded-full bg-regen-seablue hoverAnimation text-white px-5 py-2 lg:py-2 flex items-center text-xs uppercase font-bold" : "flex items-center hoverAnimation text-white px-5 py-2 lg:py-2  text-xs uppercase font-bold",
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                                        className: router.pathname == "/regenerativeProjects" ? "rounded-full bg-regen-seablue hoverAnimation text-white px-5 py-2 lg:py-2 flex items-center text-xs uppercase font-bold" : "flex items-center hoverAnimation text-white px-5 py-2 lg:py-2  text-xs uppercase font-bold",
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                                        className: router.pathname == "/artistsCollective" ? "rounded-full bg-regen-seablue hoverAnimation text-white px-5 py-2 lg:py-2 flex items-center text-xs uppercase font-bold" : "flex items-center hoverAnimation text-white px-5 py-2 lg:py-2 text-xs uppercase font-bold",
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                                        className: router.pathname == "/aboutUs" ? "rounded-full bg-regen-seablue hoverAnimation text-white px-5 py-2 lg:py-2 flex items-center text-xs uppercase font-bold" : "flex items-center hoverAnimation text-white px-5 py-2 lg:py-2 text-xs uppercase font-bold",
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
                                            href: "/aboutUs",
                                            children: "About Us"
                                        })
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,403,163], () => (__webpack_exec__(5656)));
