 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class iB{constructor(e,t){this.field=e,this.transform=t}}class iq{constructor(e,t){this.version=e,this.transformResults=t}}class i${constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new i$}static exists(e){return new i$(void 0,e)}static updateTime(e){return new i$(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function iz(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class iH{}function iK(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new i2(e.key,i$.none()):new iJ(e.key,e.data,i$.none());{let n=e.data,r=rY.empty(),i=new rT(ro.comparator);for(let s of t.fields)if(!i.has(s)){let a=n.field(s);null===a&&s.length>1&&(s=s.popLast(),a=n.field(s)),null===a?r.delete(s):r.set(s,a),i=i.add(s)}return new iY(e.key,r,new rS(i.toArray()),i$.none())}}function iG(e,t,n){e instanceof iJ?function(e,t,n){let r=e.value.clone(),i=i0(e.fieldTransforms,t,n.transformResults);r.setAll(i),t.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(e,t,n):e instanceof iY?function(e,t,n){if(!iz(e.precondition,t))return void t.convertToUnknownDocument(n.version);let r=i0(e.fieldTransforms,t,n.transformResults),i=t.data;i.setAll(iZ(e)),i.setAll(r),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):function(e,t,n){t.convertToNoDocument(n.version).setHasCommittedMutations()}(0,t,n)}function iW(e,t,n,r){var i,s,a;return e instanceof iJ?function(e,t,n,r){if(!iz(e.precondition,t))return n;let i=e.value.clone(),s=i1(e.fieldTransforms,r,t);return i.setAll(s),t.convertToFoundDocument(t.version,i).setHasLocalMutations(),null}(e,t,n,r):e instanceof iY?function(e,t,n,r){if(!iz(e.precondition,t))return n;let i=i1(e.fieldTransforms,r,t),s=t.data;return(s.setAll(iZ(e)),s.setAll(i),t.convertToFoundDocument(t.version,s).setHasLocalMutations(),null===n)?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map(e=>e.field))}(e,t,n,r):iz(e.precondition,t)?(t.convertToNoDocument(t.version).setHasLocalMutations(),null):n}function iQ(e,t){let n=null;for(let r of e.fieldTransforms){let i=t.data.field(r.field),s=iO(r.transform,i||null);null!=s&&(null===n&&(n=rY.empty()),n.set(r.field,s))}return n||null}function iX(e,t){var n,r;return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&(n=e.fieldTransforms,r=t.fieldTransforms,!!(void 0===n&&void 0===r||!(!n||!r)&&rt(n,r,(e,t)=>{var n,r,i,s;return e.field.isEqual(t.field)&&(i=e.transform,s=t.transform,i instanceof iL&&s instanceof iL||i instanceof iM&&s instanceof iM?rt(i.elements,s.elements,rV):i instanceof iF&&s instanceof iF?rV(i.yt,s.yt):i instanceof ix&&s instanceof ix)})))&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask))}class iJ extends iH{constructor(e,t,n,r=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class iY extends iH{constructor(e,t,n,r,i=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=r,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function iZ(e){let t=new Map;return e.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){let r=e.data.field(n);t.set(n,r)}}),t}function i0(e,t,n){var r;let i=new Map;(r=e.length===n.length)||nX();for(let s=0;s<n.length;s++){let a=e[s],o=a.transform,l=t.data.field(a.field);i.set(a.field,iD(o,l,n[s]))}return i}function i1(e,t,n){let r=new Map;for(let i of e){let s=i.transform,a=n.data.field(i.field);r.set(i.field,iN(s,a,t))}return r}class i2 extends iH{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class i4 extends iH{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let i9=new rb(rl.comparator),i8=new rb(rl.comparator);function i7(...e){let t=i8;for(let n of e)t=t.insert(n.key,n);return t}function se(e){let t=i8;return e.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function st(){return sr()}function sn(){return sr()}function sr(){return new i5(e=>e.toString(),(e,t)=>e.isEqual(t))}let si=new rb(rl.comparator),ss=new rT(rl.comparator);function sa(...e){let t=ss;for(let n of e)t=t.add(n);return t}let so=new rT(re);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sl{constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,n){let r=new Map;return r.set(e,su.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new sl(rr.min(),r,so,i9,sa())}}class su{constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new su(n,t,sa(),sa(),sa())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sh{constructor(e,t,n,r){this.Tt=e,this.removedTargetIds=t,this.key=n,this.Et=r}}class sc{constructor(e,t){this.targetId=e,this.At=t}}class sd{constructor(e,t,n=rk.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=r}}class sf{constructor(){this.Rt=0,this.bt=sm(),this.Pt=rk.EMPTY_BYTE_STRING,this.vt=!1,this.Vt=!0}get current(){return this.vt}get resumeToken(){return this.Pt}get St(){return 0!==this.Rt}get Dt(){return this.Vt}Ct(e){e.approximateByteSize()>0&&(this.Vt=!0,this.Pt=e)}xt(){let e=sa(),t=sa(),n=sa();return this.bt.forEach((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:nX()}}),new su(this.Pt,this.vt,e,t,n)}Nt(){this.Vt=!1,this.bt=sm()}kt(e,t){this.Vt=!0,this.bt=this.bt.insert(e,t)}Ot(e){this.Vt=!0,this.bt=this.bt.remove(e)}Mt(){this.Rt+=1}Ft(){this.Rt-=1}$t(){this.Vt=!0,this.vt=!0}}class sp{constructor(e){this.Bt=e,this.Lt=new Map,this.Ut=i9,this.qt=sg(),this.Kt=new rT(re)}Gt(e){for(let t of e.Tt)e.Et&&e.Et.isFoundDocument()?this.Qt(t,e.Et):this.jt(t,e.key,e.Et);for(let n of e.removedTargetIds)this.jt(n,e.key,e.Et)}Wt(e){this.forEachTarget(e,t=>{let n=this.zt(t);switch(e.state){case 0:this.Ht(t)&&n.Ct(e.resumeToken);break;case 1:n.Ft(),n.St||n.Nt(),n.Ct(e.resumeToken);break;case 2:n.Ft(),n.St||this.removeTarget(t);break;case 3:this.Ht(t)&&(n.$t(),n.Ct(e.resumeToken));break;case 4:this.Ht(t)&&(this.Jt(t),n.Ct(e.resumeToken));break;default:nX()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Lt.forEach((e,n)=>{this.Ht(n)&&t(n)})}Yt(e){let t=e.targetId,n=e.At.count,r=this.Xt(t);if(r){let i=r.target;if(r6(i)){if(0===n){let s=new rl(i.path);this.jt(t,s,r0.newNoDocument(s,rr.min()))}else{var a;(a=1===n)||nX()}}else this.Zt(t)!==n&&(this.Jt(t),this.Kt=this.Kt.add(t))}}te(e){let t=new Map;this.Lt.forEach((n,r)=>{let i=this.Xt(r);if(i){if(n.current&&r6(i.target)){let s=new rl(i.target.path);null!==this.Ut.get(s)||this.ee(r,s)||this.jt(r,s,r0.newNoDocument(s,e))}n.Dt&&(t.set(r,n.xt()),n.Nt())}});let n=sa();this.qt.forEach((e,t)=>{let r=!0;t.forEachWhile(e=>{let t=this.Xt(e);return!t||2===t.purpose||(r=!1,!1)}),r&&(n=n.add(e))}),this.Ut.forEach((t,n)=>n.setReadTime(e));let r=new sl(e,t,this.Kt,this.Ut,n);return this.Ut=i9,this.qt=sg(),this.Kt=new rT(re),r}Qt(e,t){if(!this.Ht(e))return;let n=this.ee(e,t.key)?2:0;this.zt(e).kt(t.key,n),this.Ut=this.Ut.insert(t.key,t),this.qt=this.qt.insert(t.key,this.ne(t.key).add(e))}jt(e,t,n){if(!this.Ht(e))return;let r=this.zt(e);this.ee(e,t)?r.kt(t,1):r.Ot(t),this.qt=this.qt.insert(t,this.ne(t).delete(e)),n&&(this.Ut=this.Ut.insert(t,n))}removeTarget(e){this.Lt.delete(e)}Zt(e){let t=this.zt(e).xt();return this.Bt.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Mt(e){this.zt(e).Mt()}zt(e){let t=this.Lt.get(e);return t||(t=new sf,this.Lt.set(e,t)),t}ne(e){let t=this.qt.get(e);return t||(t=new rT(re),this.qt=this.qt.insert(e,t)),t}Ht(e){let t=null!==this.Xt(e);return t||nK("WatchChangeAggregator","Detected inactive target",e),t}Xt(e){let t=this.Lt.get(e);return t&&t.St?null:this.Bt.se(e)}Jt(e){this.Lt.set(e,new sf),this.Bt.getRemoteKeysForTarget(e).forEach(t=>{this.jt(e,t,null)})}ee(e,t){return this.Bt.getRemoteKeysForTarget(e).has(t)}}function sg(){return new rb(rl.comparator)}function sm(){return new rb(rl.comparator)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let sy={asc:"ASCENDING",desc:"DESCENDING"},sv={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"};class sw{constructor(e,t){this.databaseId=e,this.gt=t}}function sb(e,t){return e.gt?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function s_(e,t){return e.gt?t.toBase64():t.toUint8Array()}function sI(e){return!e&&nX(),rr.fromTimestamp(function(e){let t=rA(e);return new rn(t.seconds,t.nanos)}(e))}function sT(e,t){var n;return new rs(["projects",e.projectId,"databases",e.database]).child("documents").child(t).canonicalString()}function sE(e){var t;let n=rs.fromString(e);return sx(n)||nX(),n}function sS(e,t){return sT(e.databaseId,t.path)}function sk(e,t){let n=sE(t);if(n.get(1)!==e.databaseId.projectId)throw new nY(nJ.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new nY(nJ.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new rl(sR(n))}function sC(e,t){return sT(e.databaseId,t)}function sA(e){return new rs(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function sR(e){var t;return e.length>4&&"documents"===e.get(4)||nX(),e.popFirst(5)}function sN(e,t,n){return{name:sS(e,t),fields:n.value.mapValue.fields}}function sD(e){return{fieldPath:e.canonicalString()}}function sO(e){return ro.fromServerFormat(e.fieldPath)}function sx(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sL{constructor(e,t,n,r){this.batchId=e,this.localWriteTime=t,this.baseMutations=n,this.mutations=r}applyToRemoteDocument(e,t){let n=t.mutationResults;for(let r=0;r<this.mutations.length;r++){let i=this.mutations[r];i.key.isEqual(e.key)&&iG(i,e,n[r])}}applyToLocalView(e,t){for(let n of this.baseMutations)n.key.isEqual(e.key)&&(t=iW(n,e,t,this.localWriteTime));for(let r of this.mutations)r.key.isEqual(e.key)&&(t=iW(r,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){let n=sn();return this.mutations.forEach(r=>{let i=e.get(r.key),s=i.overlayedDocument,a=this.applyToLocalView(s,i.mutatedFields);a=t.has(r.key)?null:a;let o=iK(s,a);null!==o&&n.set(r.key,o),s.isValidDocument()||s.convertToNoDocument(rr.min())}),n}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),sa())}isEqual(e){return this.batchId===e.batchId&&rt(this.mutations,e.mutations,(e,t)=>iX(e,t))&&rt(this.baseMutations,e.baseMutations,(e,t)=>iX(e,t))}}class sP{constructor(e,t,n,r){this.batch=e,this.commitVersion=t,this.mutationResults=n,this.docVersions=r}static from(e,t,n){var r;(r=e.mutations.length===n.length)||nX();let i=si,s=e.mutations;for(let a=0;a<s.length;a++)i=i.insert(s[a].key,n[a].version);return new sP(e,t,n,i)}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sU{constructor(e,t,n,r,i=rr.min(),s=rr.min(),a=rk.EMPTY_BYTE_STRING){this.target=e,this.targetId=t,this.purpose=n,this.sequenceNumber=r,this.snapshotVersion=i,this.lastLimboFreeSnapshotVersion=s,this.resumeToken=a}withSequenceNumber(e){return new sU(this.target,this.targetId,this.purpose,e,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken)}withResumeToken(e,t){return new sU(this.target,this.targetId,this.purpose,this.sequenceNumber,t,this.lastLimboFreeSnapshotVersion,e)}withLastLimboFreeSnapshotVersion(e){return new sU(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,e,this.resumeToken)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sz{constructor(){this.changes=new i5(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,r0.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();let n=this.changes.get(t);return void 0!==n?rp.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sK{constructor(e,t,n,r){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=r}getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next(r=>(n=r,this.getBaseDocument(e,t,n))).next(e=>(null!==n&&iW(n.mutation,e,rS.empty(),rn.now()),e))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(t=>this.getLocalViewOfDocuments(e,t,sa()).next(()=>t))}getLocalViewOfDocuments(e,t,n=sa()){let r=st();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,n).next(e=>{let t=i7();return e.forEach((e,n)=>{t=t.insert(e,n.overlayedDocument)}),t}))}getOverlayedDocuments(e,t){let n=st();return this.populateOverlays(e,n,t).next(()=>this.computeViews(e,t,n,sa()))}populateOverlays(e,t,n){let r=[];return n.forEach(e=>{t.has(e)||r.push(e)}),this.documentOverlayCache.getOverlays(e,r).next(e=>{e.forEach((e,n)=>{t.set(e,n)})})}computeViews(e,t,n,r){let i=i9,s=sr(),a=sr();return t.forEach((e,t)=>{let a=n.get(t.key);r.has(t.key)&&(void 0===a||a.mutation instanceof iY)?i=i.insert(t.key,t):void 0!==a&&(s.set(t.key,a.mutation.getFieldMask()),iW(a.mutation,t,a.mutation.getFieldMask(),rn.now()))}),this.recalculateAndSaveOverlays(e,i).next(e=>(e.forEach((e,t)=>s.set(e,t)),t.forEach((e,t)=>{var n;return a.set(e,new sH(t,null!==(n=s.get(e))&&void 0!==n?n:null))}),a))}recalculateAndSaveOverlays(e,t){let n=sr(),r=new rb((e,t)=>e-t),i=sa();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(e=>{for(let i of e)i.keys().forEach(e=>{let s=t.get(e);if(null===s)return;let a=n.get(e)||rS.empty();a=i.applyToLocalView(s,a),n.set(e,a);let o=(r.get(i.batchId)||sa()).add(e);r=r.insert(i.batchId,o)})}).next(()=>{let s=[],a=r.getReverseIterator();for(;a.hasNext();){let o=a.getNext(),l=o.key,u=o.value,h=sn();u.forEach(e=>{if(!i.has(e)){let r=iK(t.get(e),n.get(e));null!==r&&h.set(e,r),i=i.add(e)}}),s.push(this.documentOverlayCache.saveOverlays(e,l,h))}return rp.waitFor(s)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(t=>this.recalculateAndSaveOverlays(e,t))}getDocumentsMatchingQuery(e,t,n){var r;return rl.isDocumentKey(t.path)&&null===t.collectionGroup&&0===t.filters.length?this.getDocumentsMatchingDocumentQuery(e,t.path):iy(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n):this.getDocumentsMatchingCollectionQuery(e,t,n)}getNextDocuments(e,t,n,r){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,r).next(i=>{let s=r-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,r-i.size):rp.resolve(st()),a=-1,o=i;return s.next(t=>rp.forEach(t,(t,n)=>(a<n.largestBatchId&&(a=n.largestBatchId),i.get(t)?rp.resolve():this.getBaseDocument(e,t,n).next(e=>{o=o.insert(t,e)}))).next(()=>this.populateOverlays(e,t,i)).next(()=>this.computeViews(e,o,t,sa())).next(e=>({batchId:a,changes:se(e)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new rl(t)).next(e=>{let t=i7();return e.isFoundDocument()&&(t=t.insert(e.key,e)),t})}getDocumentsMatchingCollectionGroupQuery(e,t,n){let r=t.collectionGroup,i=i7();return this.indexManager.getCollectionParents(e,r).next(s=>rp.forEach(s,s=>{var a,o;let l=(o=s.child(r),new ic(o,null,t.explicitOrderBy.slice(),t.filters.slice(),t.limit,t.limitType,t.startAt,t.endAt));return this.getDocumentsMatchingCollectionQuery(e,l,n).next(e=>{e.forEach((e,t)=>{i=i.insert(e,t)})})}).next(()=>i))}getDocumentsMatchingCollectionQuery(e,t,n){let r;return this.remoteDocumentCache.getAllFromCollection(e,t.path,n).next(i=>(r=i,this.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId))).next(e=>{e.forEach((e,t)=>{let n=t.getKey();null===r.get(n)&&(r=r.insert(n,r0.newInvalidDocument(n)))});let n=i7();return r.forEach((r,i)=>{let s=e.get(r);void 0!==s&&iW(s.mutation,i,rS.empty(),rn.now()),iE(t,i)&&(n=n.insert(r,i))}),n})}getBaseDocument(e,t,n){return null===n||1===n.mutation.type?this.remoteDocumentCache.getEntry(e,t):rp.resolve(r0.newInvalidDocument(t))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sG{constructor(e){this.It=e,this.Zn=new Map,this.ts=new Map}getBundleMetadata(e,t){return rp.resolve(this.Zn.get(t))}saveBundleMetadata(e,t){return this.Zn.set(t.id,{id:t.id,version:t.version,createTime:sI(t.createTime)}),rp.resolve()}getNamedQuery(e,t){return rp.resolve(this.ts.get(t))}saveNamedQuery(e,t){var n;return this.ts.set(t.name,{name:t.name,query:function(e){let t=function(e){var t,n,r,i,s,a,o,l,u;let h=function(e){let t=sE(e);return 4===t.length?rs.emptyPath():sR(t)}(e.parent),c=e.structuredQuery,d=c.from?c.from.length:0,f=null;if(d>0){(t=1===d)||nX();let p=c.from[0];p.allDescendants?f=p.collectionId:h=h.child(p.collectionId)}let g=[];c.where&&(g=function e(t){var n;return t?void 0!==t.unaryFilter?[function(e){switch(e.unaryFilter.op){case"IS_NAN":let t=sO(e.unaryFilter.field);return r5.create(t,"==",{doubleValue:NaN});case"IS_NULL":let n=sO(e.unaryFilter.field);return r5.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":let r=sO(e.unaryFilter.field);return r5.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":let i=sO(e.unaryFilter.field);return r5.create(i,"!=",{nullValue:"NULL_VALUE"});default:return nX()}}(t)]:void 0!==t.fieldFilter?[(n=t,r5.create(sO(n.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return nX()}}(n.fieldFilter.op),n.fieldFilter.value))]:void 0!==t.compositeFilter?t.compositeFilter.filters.map(t=>e(t)).reduce((e,t)=>e.concat(t)):nX():[]}(c.where));let m=[];c.orderBy&&(m=c.orderBy.map(e=>{var t;return new io(sO(e.field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(e.direction))}));let y=null,v;c.limit&&(y=rP(v="object"==typeof(n=c.limit)?n.value:n)?null:v);let w=null;c.startAt&&(w=function(e){let t=!!e.before,n=e.values||[];return new ia(n,t)}(c.startAt));let b=null;return c.endAt&&(b=function(e){let t=!e.before,n=e.values||[];return new ia(n,t)}(c.endAt)),r=h,i=f,s=m,a=g,o=y,l=w,u=b,new ic(r,i,s,a,o,"F",l,u)}({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?ib(t,t.limit,"L"):t}(t.bundledQuery),readTime:sI(t.readTime)}),rp.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sW{constructor(){this.overlays=new rb(rl.comparator),this.es=new Map}getOverlay(e,t){return rp.resolve(this.overlays.get(t))}getOverlays(e,t){let n=st();return rp.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((n,r)=>{this.ue(e,t,r)}),rp.resolve()}removeOverlaysForBatchId(e,t,n){let r=this.es.get(n);return void 0!==r&&(r.forEach(e=>this.overlays=this.overlays.remove(e)),this.es.delete(n)),rp.resolve()}getOverlaysForCollection(e,t,n){let r=st(),i=t.length+1,s=new rl(t.child("")),a=this.overlays.getIteratorFrom(s);for(;a.hasNext();){let o=a.getNext().value,l=o.getKey();if(!t.isPrefixOf(l.path))break;l.path.length===i&&o.largestBatchId>n&&r.set(o.getKey(),o)}return rp.resolve(r)}getOverlaysForCollectionGroup(e,t,n,r){let i=new rb((e,t)=>e-t),s=this.overlays.getIterator();for(;s.hasNext();){let a=s.getNext().value;if(a.getKey().getCollectionGroup()===t&&a.largestBatchId>n){let o=i.get(a.largestBatchId);null===o&&(o=st(),i=i.insert(a.largestBatchId,o)),o.set(a.getKey(),a)}}let l=st(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((e,t)=>l.set(e,t)),!(l.size()>=r)););return rp.resolve(l)}ue(e,t,n){let r=this.overlays.get(n.key);if(null!==r){let i=this.es.get(r.largestBatchId).delete(n.key);this.es.set(r.largestBatchId,i)}this.overlays=this.overlays.insert(n.key,new sM(t,n));let s=this.es.get(t);void 0===s&&(s=sa(),this.es.set(t,s)),this.es.set(t,s.add(n.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sQ{constructor(){this.ns=new rT(sX.ss),this.rs=new rT(sX.os)}isEmpty(){return this.ns.isEmpty()}addReference(e,t){let n=new sX(e,t);this.ns=this.ns.add(n),this.rs=this.rs.add(n)}us(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.cs(new sX(e,t))}hs(e,t){e.forEach(e=>this.removeReference(e,t))}ls(e){let t=new rl(new rs([])),n=new sX(t,e),r=new sX(t,e+1),i=[];return this.rs.forEachInRange([n,r],e=>{this.cs(e),i.push(e.key)}),i}fs(){this.ns.forEach(e=>this.cs(e))}cs(e){this.ns=this.ns.delete(e),this.rs=this.rs.delete(e)}ds(e){let t=new rl(new rs([])),n=new sX(t,e),r=new sX(t,e+1),i=sa();return this.rs.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new sX(e,0),n=this.ns.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class sX{constructor(e,t){this.key=e,this._s=t}static ss(e,t){return rl.comparator(e.key,t.key)||re(e._s,t._s)}static os(e,t){return re(e._s,t._s)||rl.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sJ{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.ws=1,this.gs=new rT(sX.ss)}checkEmpty(e){return rp.resolve(0===this.mutationQueue.length)}addMutationBatch(e,t,n,r){let i=this.ws;this.ws++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];let s=new sL(i,t,n,r);for(let a of(this.mutationQueue.push(s),r))this.gs=this.gs.add(new sX(a.key,i)),this.indexManager.addToCollectionParentIndex(e,a.key.path.popLast());return rp.resolve(s)}lookupMutationBatch(e,t){return rp.resolve(this.ys(t))}getNextMutationBatchAfterBatchId(e,t){let n=this.ps(t+1),r=n<0?0:n;return rp.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return rp.resolve(0===this.mutationQueue.length?-1:this.ws-1)}getAllMutationBatches(e){return rp.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){let n=new sX(t,0),r=new sX(t,Number.POSITIVE_INFINITY),i=[];return this.gs.forEachInRange([n,r],e=>{let t=this.ys(e._s);i.push(t)}),rp.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new rT(re);return t.forEach(e=>{let t=new sX(e,0),r=new sX(e,Number.POSITIVE_INFINITY);this.gs.forEachInRange([t,r],e=>{n=n.add(e._s)})}),rp.resolve(this.Is(n))}getAllMutationBatchesAffectingQuery(e,t){let n=t.path,r=n.length+1,i=n;rl.isDocumentKey(i)||(i=i.child(""));let s=new sX(new rl(i),0),a=new rT(re);return this.gs.forEachWhile(e=>{let t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===r&&(a=a.add(e._s)),!0)},s),rp.resolve(this.Is(a))}Is(e){let t=[];return e.forEach(e=>{let n=this.ys(e);null!==n&&t.push(n)}),t}removeMutationBatch(e,t){var n;0===this.Ts(t.batchId,"removed")||nX(),this.mutationQueue.shift();let r=this.gs;return rp.forEach(t.mutations,n=>{let i=new sX(n.key,t.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,n.key)}).next(()=>{this.gs=r})}An(e){}containsKey(e,t){let n=new sX(t,0),r=this.gs.firstAfterOrEqual(n);return rp.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,rp.resolve()}Ts(e,t){return this.ps(e)}ps(e){return 0===this.mutationQueue.length?0:e-this.mutationQueue[0].batchId}ys(e){let t=this.ps(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class sY{constructor(e){this.Es=e,this.docs=new rb(rl.comparator),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){let n=t.key,r=this.docs.get(n),i=r?r.size:0,s=this.Es(t);return this.docs=this.docs.insert(n,{document:t.mutableCopy(),size:s}),this.size+=s-i,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}removeEntry(e){let t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){let n=this.docs.get(t);return rp.resolve(n?n.document.mutableCopy():r0.newInvalidDocument(t))}getEntries(e,t){let n=i9;return t.forEach(e=>{let t=this.docs.get(e);n=n.insert(e,t?t.document.mutableCopy():r0.newInvalidDocument(e))}),rp.resolve(n)}getAllFromCollection(e,t,n){let r=i9,i=new rl(t.child("")),s=this.docs.getIteratorFrom(i);for(;s.hasNext();){let{key:a,value:{document:o}}=s.getNext();if(!t.isPrefixOf(a.path))break;a.path.length>t.length+1||0>=rc(ru(o),n)||(r=r.insert(o.key,o.mutableCopy()))}return rp.resolve(r)}getAllFromCollectionGroup(e,t,n,r){nX()}As(e,t){return rp.forEach(this.docs,e=>t(e))}newChangeBuffer(e){return new sZ(this)}getSize(e){return rp.resolve(this.size)}}class sZ extends sz{constructor(e){super(),this.Yn=e}applyChanges(e){let t=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?t.push(this.Yn.addEntry(e,r)):this.Yn.removeEntry(n)}),rp.waitFor(t)}getFromCache(e,t){return this.Yn.getEntry(e,t)}getAllFromCache(e,t){return this.Yn.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class s1{constructor(e,t){var n;this.Vs={},this.overlays={},this.Ss=new rm(0),this.Ds=!1,this.Ds=!0,this.referenceDelegate=e(this),this.Cs=new s0(this),this.indexManager=new sj,this.remoteDocumentCache=(n=e=>this.referenceDelegate.xs(e),new sY(n)),this.It=new sF(t),this.Ns=new sG(this.It)}start(){return Promise.resolve()}shutdown(){return this.Ds=!1,Promise.resolve()}get started(){return this.Ds}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new sW,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.Vs[e.toKey()];return n||(n=new sJ(t,this.referenceDelegate),this.Vs[e.toKey()]=n),n}getTargetCache(){return this.Cs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ns}runTransaction(e,t,n){nK("MemoryPersistence","Starting transaction:",e);let r=new s2(this.Ss.next());return this.referenceDelegate.ks(),n(r).next(e=>this.referenceDelegate.Os(r).next(()=>e)).toPromise().then(e=>(r.raiseOnCommittedEvent(),e))}Ms(e,t){return rp.or(Object.values(this.Vs).map(n=>()=>n.containsKey(e,t)))}}class s2 extends rd{constructor(e){super(),this.currentSequenceNumber=e}}class s4{constructor(e){this.persistence=e,this.Fs=new sQ,this.$s=null}static Bs(e){return new s4(e)}get Ls(){if(this.$s)return this.$s;throw nX()}addReference(e,t,n){return this.Fs.addReference(n,t),this.Ls.delete(n.toString()),rp.resolve()}removeReference(e,t,n){return this.Fs.removeReference(n,t),this.Ls.add(n.toString()),rp.resolve()}markPotentiallyOrphaned(e,t){return this.Ls.add(t.toString()),rp.resolve()}removeTarget(e,t){this.Fs.ls(t.targetId).forEach(e=>this.Ls.add(e.toString()));let n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next(e=>{e.forEach(e=>this.Ls.add(e.toString()))}).next(()=>n.removeTargetData(e,t))}ks(){this.$s=new Set}Os(e){let t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return rp.forEach(this.Ls,n=>{let r=rl.fromPath(n);return this.Us(e,r).next(e=>{e||t.removeEntry(r,rr.min())})}).next(()=>(this.$s=null,t.apply(e)))}updateLimboDocument(e,t){return this.Us(e,t).next(e=>{e?this.Ls.delete(t.toString()):this.Ls.add(t.toString())})}xs(e){return 0}Us(e,t){return rp.or([()=>rp.resolve(this.Fs.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ms(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class s3{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Si=n,this.Di=r}static Ci(e,t){let n=sa(),r=sa();for(let i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new s3(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class s5{constructor(e,t,n,r){this.persistence=e,this.Li=t,this.It=r,this.Ui=new rb(re),this.qi=new i5(e=>r4(e),r3),this.Ki=new Map,this.Gi=e.getRemoteDocumentCache(),this.Cs=e.getTargetCache(),this.Ns=e.getBundleCache(),this.Qi(n)}Qi(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new sK(this.Gi,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Gi.setIndexManager(this.indexManager),this.Li.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.Ui))}}async function s9(e,t){var n;return await e.persistence.runTransaction("Handle user change","readonly",n=>{let r;return e.mutationQueue.getAllMutationBatches(n).next(i=>(r=i,e.Qi(t),e.mutationQueue.getAllMutationBatches(n))).next(t=>{let i=[],s=[],a=sa();for(let o of r)for(let l of(i.push(o.batchId),o.mutations))a=a.add(l.key);for(let u of t)for(let h of(s.push(u.batchId),u.mutations))a=a.add(h.key);return e.localDocuments.getDocuments(n,a).next(e=>({ji:e,removedBatchIds:i,addedBatchIds:s}))})})}function s8(e){var t;return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Cs.getLastRemoteSnapshotVersion(t))}function s7(e,t){var n;return e.persistence.runTransaction("Get next mutation batch","readonly",n=>(void 0===t&&(t=-1),e.mutationQueue.getNextMutationBatchAfterBatchId(n,t)))}async function ae(e,t,n){var r;let i=e,s=i.Ui.get(t);try{n||await i.persistence.runTransaction("Release target",n?"readwrite":"readwrite-primary",e=>i.persistence.referenceDelegate.removeTarget(e,s))}catch(a){if(!rg(a))throw a;nK("LocalStore",`Failed to update sequence numbers for target ${t}: ${a}`)}i.Ui=i.Ui.remove(t),i.qi.delete(s.target)}function at(e,t,n){var r;let i=rr.min(),s=sa();return e.persistence.runTransaction("Execute query","readonly",r=>(function(e,t,n){var r;let i=e.qi.get(n);return void 0!==i?rp.resolve(e.Ui.get(i)):e.Cs.getTargetData(t,n)})(e,r,iw(t)).next(t=>{if(t)return i=t.lastLimboFreeSnapshotVersion,e.Cs.getMatchingKeysForTargetId(r,t.targetId).next(e=>{s=e})}).next(()=>e.Li.getDocumentsMatchingQuery(r,t,n?i:rr.min(),n?s:sa())).next(n=>{var r,i,a,o;let l;return i=e,a=t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2)),o=n,l=i.Ki.get(a)||rr.min(),o.forEach((e,t)=>{t.readTime.compareTo(l)>0&&(l=t.readTime)}),i.Ki.set(a,l),{documents:n,Hi:s}}))}class an{constructor(){this.activeTargetIds=so}er(e){this.activeTargetIds=this.activeTargetIds.add(e)}nr(e){this.activeTargetIds=this.activeTargetIds.delete(e)}tr(){let e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class ar{constructor(){this.Lr=new an,this.Ur={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e){return this.Lr.er(e),this.Ur[e]||"not-current"}updateQueryState(e,t,n){this.Ur[e]=t}removeLocalQueryTarget(e){this.Lr.nr(e)}isLocalQueryTarget(e){return this.Lr.activeTargetIds.has(e)}clearQueryState(e){delete this.Ur[e]}getAllActiveQueryTargets(){return this.Lr.activeTargetIds}isActiveQueryTarget(e){return this.Lr.activeTargetIds.has(e)}start(){return this.Lr=new an,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let aa={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class ad{constructor(e,t,n,r,i,s,a,o){this.Hs=e,this.vo=n,this.Vo=r,this.connection=i,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=a,this.listener=o,this.state=0,this.So=0,this.Do=null,this.Co=null,this.stream=null,this.xo=new ac(e,t)}No(){return 1===this.state||5===this.state||this.ko()}ko(){return 2===this.state||3===this.state}start(){4!==this.state?this.auth():this.Oo()}async stop(){this.No()&&await this.close(0)}Mo(){this.state=0,this.xo.reset()}Fo(){this.ko()&&null===this.Do&&(this.Do=this.Hs.enqueueAfterDelay(this.vo,6e4,()=>this.$o()))}Bo(e){this.Lo(),this.stream.send(e)}async $o(){if(this.ko())return this.close(0)}Lo(){this.Do&&(this.Do.cancel(),this.Do=null)}Uo(){this.Co&&(this.Co.cancel(),this.Co=null)}async close(e,t){this.Lo(),this.Uo(),this.xo.cancel(),this.So++,4!==e?this.xo.reset():t&&t.code===nJ.RESOURCE_EXHAUSTED?(nG(t.toString()),nG("Using maximum backoff delay to prevent overloading the backend."),this.xo.Ao()):t&&t.code===nJ.UNAUTHENTICATED&&3!==this.state&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),null!==this.stream&&(this.qo(),this.stream.close(),this.stream=null),this.state=e,await this.listener.Zr(t)}qo(){}auth(){this.state=1;let e=this.Ko(this.So),t=this.So;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([e,n])=>{this.So===t&&this.Go(e,n)},t=>{e(()=>{let e=new nY(nJ.UNKNOWN,"Fetching auth token failed: "+t.message);return this.Qo(e)})})}Go(e,t){let n=this.Ko(this.So);this.stream=this.jo(e,t),this.stream.Yr(()=>{n(()=>(this.state=2,this.Co=this.Hs.enqueueAfterDelay(this.Vo,1e4,()=>(this.ko()&&(this.state=3),Promise.resolve())),this.listener.Yr()))}),this.stream.Zr(e=>{n(()=>this.Qo(e))}),this.stream.onMessage(e=>{n(()=>this.onMessage(e))})}Oo(){this.state=5,this.xo.Ro(async()=>{this.state=0,this.start()})}Qo(e){return nK("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}Ko(e){return t=>{this.Hs.enqueueAndForget(()=>this.So===e?t():(nK("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class af extends ad{constructor(e,t,n,r,i,s){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,r,s),this.It=i}jo(e,t){return this.connection.wo("Listen",e,t)}onMessage(e){this.xo.reset();let t=function(e,t){let n;if("targetChange"in t){var r,i,s,a;t.targetChange;let o="NO_CHANGE"===(r=t.targetChange.targetChangeType||"NO_CHANGE")?0:"ADD"===r?1:"REMOVE"===r?2:"CURRENT"===r?3:"RESET"===r?4:nX(),l=t.targetChange.targetIds||[],u=(s=t.targetChange.resumeToken,e.gt?(void 0===s||"string"==typeof s||nX(),rk.fromBase64String(s||"")):(void 0===s||s instanceof Uint8Array||nX(),rk.fromUint8Array(s||new Uint8Array))),h=t.targetChange.cause,c=h&&function(e){let t=void 0===e.code?nJ.UNKNOWN:i6(e.code);return new nY(t,e.message||"")}(h);n=new sd(o,l,u,c||null)}else if("documentChange"in t){t.documentChange;let d=t.documentChange;d.document,d.document.name,d.document.updateTime;let f=sk(e,d.document.name),p=sI(d.document.updateTime),g=new rY({mapValue:{fields:d.document.fields}}),m=r0.newFoundDocument(f,p,g),y=d.targetIds||[],v=d.removedTargetIds||[];n=new sh(y,v,m.key,m)}else if("documentDelete"in t){t.documentDelete;let w=t.documentDelete;w.document;let b=sk(e,w.document),_=w.readTime?sI(w.readTime):rr.min(),I=r0.newNoDocument(b,_),T=w.removedTargetIds||[];n=new sh([],T,I.key,I)}else if("documentRemove"in t){t.documentRemove;let E=t.documentRemove;E.document;let S=sk(e,E.document),k=E.removedTargetIds||[];n=new sh([],k,S,null)}else{if(!("filter"in t))return nX();{t.filter;let C=t.filter;C.targetId;let A=C.count||0,R=new i3(A),N=C.targetId;n=new sc(N,R)}}return n}(this.It,e),n=function(e){if(!("targetChange"in e))return rr.min();let t=e.targetChange;return t.targetIds&&t.targetIds.length?rr.min():t.readTime?sI(t.readTime):rr.min()}(e);return this.listener.Wo(t,n)}zo(e){let t={};t.database=sA(this.It),t.addTarget=function(e,t){var n,r;let i,s=t.target;return(i=r6(s)?{documents:{documents:[sC(e,s.path)]}}:{query:function(e,t){var n,r,i,s;let a={structuredQuery:{}},o=t.path;null!==t.collectionGroup?(a.parent=sC(e,o),a.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(a.parent=sC(e,o.popLast()),a.structuredQuery.from=[{collectionId:o.lastSegment()}]);let l=function(e){if(0===e.length)return;let t=e.map(e=>(function(e){var t;if("=="===e.op){if(rW(e.value))return{unaryFilter:{field:sD(e.field),op:"IS_NAN"}};if(rG(e.value))return{unaryFilter:{field:sD(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(rW(e.value))return{unaryFilter:{field:sD(e.field),op:"IS_NOT_NAN"}};if(rG(e.value))return{unaryFilter:{field:sD(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:sD(e.field),op:(t=e.op,sv[t]),value:e.value}}})(e));return 1===t.length?t[0]:{compositeFilter:{op:"AND",filters:t}}}(t.filters);l&&(a.structuredQuery.where=l);let u=function(e){if(0!==e.length)return e.map(e=>{var t,n;return{field:sD(e.field),direction:(n=e.dir,sy[n])}})}(t.orderBy);u&&(a.structuredQuery.orderBy=u);let h=(i=t.limit,e.gt||rP(i)?i:{value:i});return null!==h&&(a.structuredQuery.limit=h),t.startAt&&(a.structuredQuery.startAt={before:(n=t.startAt).inclusive,values:n.position}),t.endAt&&(a.structuredQuery.endAt={before:!(s=t.endAt).inclusive,values:s.position}),a}(e,s)}).targetId=t.targetId,t.resumeToken.approximateByteSize()>0?i.resumeToken=s_(e,t.resumeToken):t.snapshotVersion.compareTo(rr.min())>0&&(i.readTime=sb(e,t.snapshotVersion.toTimestamp())),i}(this.It,e);let n=function(e,t){let n=function(e,t){switch(t){case 0:return null;case 1:return"existence-filter-mismatch";case 2:return"limbo-document";default:return nX()}}(0,t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.It,e);n&&(t.labels=n),this.Bo(t)}Ho(e){let t={};t.database=sA(this.It),t.removeTarget=e,this.Bo(t)}}class ap extends ad{constructor(e,t,n,r,i,s){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,r,s),this.It=i,this.Jo=!1}get Yo(){return this.Jo}start(){this.Jo=!1,this.lastStreamToken=void 0,super.start()}qo(){this.Jo&&this.Xo([])}jo(e,t){return this.connection.wo("Write",e,t)}onMessage(e){var t,n,r,i;if(!e.streamToken&&nX(),this.lastStreamToken=e.streamToken,this.Jo){this.xo.reset();let s=(n=e.writeResults,r=e.commitTime,n&&n.length>0?(void 0!==r||nX(),n.map(e=>{var t,n;let i;return n=r,(i=e.updateTime?sI(e.updateTime):sI(n)).isEqual(rr.min())&&(i=sI(n)),new iq(i,e.transformResults||[])})):[]),a=sI(e.commitTime);return this.listener.Zo(a,s)}return e.writeResults&&0!==e.writeResults.length&&nX(),this.Jo=!0,this.listener.tu()}eu(){let e={};e.database=sA(this.It),this.Bo(e)}Xo(e){let t={streamToken:this.lastStreamToken,writes:e.map(e=>(function(e,t){var n,r,i,s;let a;if(t instanceof iJ)a={update:sN(e,t.key,t.value)};else if(t instanceof i2)a={delete:sS(e,t.key)};else if(t instanceof iY)a={update:sN(e,t.key,t.data),updateMask:function(e){let t=[];return e.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}(t.fieldMask)};else{if(!(t instanceof i4))return nX();a={verify:sS(e,t.key)}}return t.fieldTransforms.length>0&&(a.updateTransforms=t.fieldTransforms.map(e=>(function(e,t){let n=t.transform;if(n instanceof ix)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof iL)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof iM)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof iF)return{fieldPath:t.field.canonicalString(),increment:n.yt};throw nX()})(0,e))),t.precondition.isNone||(a.currentDocument=void 0!==(r=t.precondition).updateTime?{updateTime:sb(e,(s=r.updateTime).toTimestamp())}:void 0!==r.exists?{exists:r.exists}:nX()),a})(this.It,e))};this.Bo(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class ay{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.fu=[],this.du=new Map,this._u=new Set,this.wu=[],this.mu=i,this.mu.qr(e=>{n.enqueueAndForget(async()=>{ak(this)&&(nK("RemoteStore","Restarting streams for network reachability change."),await async function(e){var t;e._u.add(4),await aw(e),e.gu.set("Unknown"),e._u.delete(4),await av(e)}(this))})}),this.gu=new am(n,r)}}async function av(e){if(ak(e))for(let t of e.wu)await t(!0)}async function aw(e){for(let t of e.wu)await t(!1)}function ab(e,t){var n;e.du.has(t.targetId)||(e.du.set(t.targetId,t),aS(e)?aE(e):az(e).ko()&&aI(e,t))}function a_(e,t){var n;let r=az(e);e.du.delete(t),r.ko()&&aT(e,t),0===e.du.size&&(r.ko()?r.Fo():ak(e)&&e.gu.set("Unknown"))}function aI(e,t){e.yu.Mt(t.targetId),az(e).zo(t)}function aT(e,t){e.yu.Mt(t),az(e).Ho(t)}function aE(e){e.yu=new sp({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),se:t=>e.du.get(t)||null}),az(e).start(),e.gu.uu()}function aS(e){return ak(e)&&!az(e).No()&&e.du.size>0}function ak(e){var t;return 0===e._u.size}function aC(e){e.yu=void 0}async function aA(e){e.du.forEach((t,n)=>{aI(e,t)})}async function aR(e,t){aC(e),aS(e)?(e.gu.hu(t),aE(e)):e.gu.set("Unknown")}async function aN(e,t,n){if(e.gu.set("Online"),t instanceof sd&&2===t.state&&t.cause)try{await async function(e,t){let n=t.cause;for(let r of t.targetIds)e.du.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.du.delete(r),e.yu.removeTarget(r))}(e,t)}catch(r){nK("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),r),await aD(e,r)}else if(t instanceof sh?e.yu.Gt(t):t instanceof sc?e.yu.Yt(t):e.yu.Wt(t),!n.isEqual(rr.min()))try{let i=await s8(e.localStore);n.compareTo(i)>=0&&await function(e,t){let n=e.yu.te(t);return n.targetChanges.forEach((n,r)=>{if(n.resumeToken.approximateByteSize()>0){let i=e.du.get(r);i&&e.du.set(r,i.withResumeToken(n.resumeToken,t))}}),n.targetMismatches.forEach(t=>{let n=e.du.get(t);if(!n)return;e.du.set(t,n.withResumeToken(rk.EMPTY_BYTE_STRING,n.snapshotVersion)),aT(e,t);let r=new sU(n.target,t,1,n.sequenceNumber);aI(e,r)}),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(s){nK("RemoteStore","Failed to raise snapshot:",s),await aD(e,s)}}async function aD(e,t,n){if(!rg(t))throw t;e._u.add(1),await aw(e),e.gu.set("Offline"),n||(n=()=>s8(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{nK("RemoteStore","Retrying IndexedDB access"),await n(),e._u.delete(1),await av(e)})}function aO(e,t){return t().catch(n=>aD(e,n,t))}async function ax(e){var t;let n=aH(e),r=e.fu.length>0?e.fu[e.fu.length-1].batchId:-1;for(;aL(e);)try{let i=await s7(e.localStore,r);if(null===i){0===e.fu.length&&n.Fo();break}r=i.batchId,aP(e,i)}catch(s){await aD(e,s)}aM(e)&&aU(e)}function aL(e){return ak(e)&&e.fu.length<10}function aP(e,t){e.fu.push(t);let n=aH(e);n.ko()&&n.Yo&&n.Xo(t.mutations)}function aM(e){return ak(e)&&!aH(e).No()&&e.fu.length>0}function aU(e){aH(e).start()}async function aF(e){aH(e).eu()}async function aV(e){let t=aH(e);for(let n of e.fu)t.Xo(n.mutations)}async function aj(e,t,n){let r=e.fu.shift(),i=sP.from(r,t,n);await aO(e,()=>e.remoteSyncer.applySuccessfulWrite(i)),await ax(e)}async function aB(e,t){t&&aH(e).Yo&&await async function(e,t){var n;if(function(e){switch(e){default:return nX();case nJ.CANCELLED:case nJ.UNKNOWN:case nJ.DEADLINE_EXCEEDED:case nJ.RESOURCE_EXHAUSTED:case nJ.INTERNAL:case nJ.UNAVAILABLE:case nJ.UNAUTHENTICATED:return!1;case nJ.INVALID_ARGUMENT:case nJ.NOT_FOUND:case nJ.ALREADY_EXISTS:case nJ.PERMISSION_DENIED:case nJ.FAILED_PRECONDITION:case nJ.ABORTED:case nJ.OUT_OF_RANGE:case nJ.UNIMPLEMENTED:case nJ.DATA_LOSS:return!0}}(n=t.code)&&n!==nJ.ABORTED){let r=e.fu.shift();aH(e).Mo(),await aO(e,()=>e.remoteSyncer.rejectFailedWrite(r.batchId,t)),await ax(e)}}(e,t),aM(e)&&aU(e)}async function aq(e,t){var n;e.asyncQueue.verifyOperationInProgress(),nK("RemoteStore","RemoteStore received new credentials");let r=ak(e);e._u.add(3),await aw(e),r&&e.gu.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e._u.delete(3),await av(e)}async function a$(e,t){var n;t?(e._u.delete(2),await av(e)):t||(e._u.add(2),await aw(e),e.gu.set("Unknown"))}function az(e){return e.pu||(e.pu=function(e,t,n){var r;return e.su(),new af(t,e.connection,e.authCredentials,e.appCheckCredentials,e.It,n)}(e.datastore,e.asyncQueue,{Yr:aA.bind(null,e),Zr:aR.bind(null,e),Wo:aN.bind(null,e)}),e.wu.push(async t=>{t?(e.pu.Mo(),aS(e)?aE(e):e.gu.set("Unknown")):(await e.pu.stop(),aC(e))})),e.pu}function aH(e){return e.Iu||(e.Iu=function(e,t,n){var r;return e.su(),new ap(t,e.connection,e.authCredentials,e.appCheckCredentials,e.It,n)}(e.datastore,e.asyncQueue,{Yr:aF.bind(null,e),Zr:aB.bind(null,e),tu:aV.bind(null,e),Zo:aj.bind(null,e)}),e.wu.push(async t=>{t?(e.Iu.Mo(),await ax(e)):(await e.Iu.stop(),e.fu.length>0&&(nK("RemoteStore",`Stopping write stream with ${e.fu.length} pending writes`),e.fu=[]))})),e.Iu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class aK{constructor(e,t,n,r,i){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=r,this.removalCallback=i,this.deferred=new nZ,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(e=>{})}static createAndSchedule(e,t,n,r,i){let s=Date.now()+n,a=new aK(e,t,s,r,i);return a.start(n),a}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new nY(nJ.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function aG(e,t){if(nG("AsyncQueue",`${t}: ${e}`),rg(e))return new nY(nJ.UNAVAILABLE,`${t}: ${e}`);throw e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class aW{constructor(e){this.comparator=e?(t,n)=>e(t,n)||rl.comparator(t.key,n.key):(e,t)=>rl.comparator(e.key,t.key),this.keyedMap=i7(),this.sortedSet=new rb(this.comparator)}static emptySet(e){return new aW(e.comparator)}has(e){return null!=this.keyedMap.get(e)}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){let t=this.keyedMap.get(e);return t?this.sortedSet.indexOf(t):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((t,n)=>(e(t),!1))}add(e){let t=this.delete(e.key);return t.copy(t.keyedMap.insert(e.key,e),t.sortedSet.insert(e,null))}delete(e){let t=this.get(e);return t?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(t)):this}isEqual(e){if(!(e instanceof aW)||this.size!==e.size)return!1;let t=this.sortedSet.getIterator(),n=e.sortedSet.getIterator();for(;t.hasNext();){let r=t.getNext().key,i=n.getNext().key;if(!r.isEqual(i))return!1}return!0}toString(){let e=[];return this.forEach(t=>{e.push(t.toString())}),0===e.length?"DocumentSet ()":"DocumentSet (\n  "+e.join("  \n")+"\n)"}copy(e,t){let n=new aW;return n.comparator=this.comparator,n.keyedMap=e,n.sortedSet=t,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class aJ{constructor(){this.Au=void 0,this.listeners=[]}}class aY{constructor(){this.queries=new i5(e=>iI(e),i_),this.onlineState="Unknown",this.Ru=new Set}}async function aZ(e,t){var n;let r=t.query,i=!1,s=e.queries.get(r);if(s||(i=!0,s=new aJ),i)try{s.Au=await e.onListen(r)}catch(o){let a=aG(o,`Initialization of query '${iT(t.query)}' failed`);return void t.onError(a)}e.queries.set(r,s),s.listeners.push(t),t.bu(e.onlineState),s.Au&&t.Pu(s.Au)&&a4(e)}async function a0(e,t){var n;let r=t.query,i=!1,s=e.queries.get(r);if(s){let a=s.listeners.indexOf(t);a>=0&&(s.listeners.splice(a,1),i=0===s.listeners.length)}if(i)return e.queries.delete(r),e.onUnlisten(r)}function a1(e,t){var n;let r=!1;for(let i of t){let s=i.query,a=e.queries.get(s);if(a){for(let o of a.listeners)o.Pu(i)&&(r=!0);a.Au=i}}r&&a4(e)}function a2(e,t,n){var r;let i=e.queries.get(t);if(i)for(let s of i.listeners)s.onError(n);e.queries.delete(t)}function a4(e){e.Ru.forEach(e=>{e.next()})}class a3{constructor(e,t,n){this.query=e,this.vu=t,this.Vu=!1,this.Su=null,this.onlineState="Unknown",this.options=n||{}}Pu(e){if(!this.options.includeMetadataChanges){let t=[];for(let n of e.docChanges)3!==n.type&&t.push(n);e=new aX(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let r=!1;return this.Vu?this.Du(e)&&(this.vu.next(e),r=!0):this.Cu(e,this.onlineState)&&(this.xu(e),r=!0),this.Su=e,r}onError(e){this.vu.error(e)}bu(e){this.onlineState=e;let t=!1;return this.Su&&!this.Vu&&this.Cu(this.Su,e)&&(this.xu(this.Su),t=!0),t}Cu(e,t){return!e.fromCache||(!this.options.Nu||!("Offline"!==t))&&(!e.docs.isEmpty()||e.hasCachedResults||"Offline"===t)}Du(e){if(e.docChanges.length>0)return!0;let t=this.Su&&this.Su.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}xu(e){e=aX.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Vu=!0,this.vu.next(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class a6{constructor(e){this.key=e}}class a5{constructor(e){this.key=e}}class a9{constructor(e,t){this.query=e,this.Uu=t,this.qu=null,this.hasCachedResults=!1,this.current=!1,this.Ku=sa(),this.mutatedKeys=sa(),this.Gu=iS(e),this.Qu=new aW(this.Gu)}get ju(){return this.Uu}Wu(e,t){let n=t?t.zu:new aQ,r=t?t.Qu:this.Qu,i=t?t.mutatedKeys:this.mutatedKeys,s=r,a=!1,o="F"===this.query.limitType&&r.size===this.query.limit?r.last():null,l="L"===this.query.limitType&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal((e,t)=>{let u=r.get(e),h=iE(this.query,t)?t:null,c=!!u&&this.mutatedKeys.has(u.key),d=!!h&&(h.hasLocalMutations||this.mutatedKeys.has(h.key)&&h.hasCommittedMutations),f=!1;u&&h?u.data.isEqual(h.data)?c!==d&&(n.track({type:3,doc:h}),f=!0):this.Hu(u,h)||(n.track({type:2,doc:h}),f=!0,(o&&this.Gu(h,o)>0||l&&0>this.Gu(h,l))&&(a=!0)):!u&&h?(n.track({type:0,doc:h}),f=!0):u&&!h&&(n.track({type:1,doc:u}),f=!0,(o||l)&&(a=!0)),f&&(h?(s=s.add(h),i=d?i.add(e):i.delete(e)):(s=s.delete(e),i=i.delete(e)))}),null!==this.query.limit)for(;s.size>this.query.limit;){let u="F"===this.query.limitType?s.last():s.first();s=s.delete(u.key),i=i.delete(u.key),n.track({type:1,doc:u})}return{Qu:s,zu:n,$i:a,mutatedKeys:i}}Hu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n){let r=this.Qu;this.Qu=e.Qu,this.mutatedKeys=e.mutatedKeys;let i=e.zu.Eu();i.sort((e,t)=>(function(e,t){let n=e=>{switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return nX()}};return n(e)-n(t)})(e.type,t.type)||this.Gu(e.doc,t.doc)),this.Ju(n);let s=t?this.Yu():[],a=0===this.Ku.size&&this.current?1:0,o=a!==this.qu;return(this.qu=a,0!==i.length||o)?{snapshot:new aX(this.query,e.Qu,r,i,e.mutatedKeys,0===a,o,!1,!!n&&n.resumeToken.approximateByteSize()>0),Xu:s}:{Xu:s}}bu(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({Qu:this.Qu,zu:new aQ,mutatedKeys:this.mutatedKeys,$i:!1},!1)):{Xu:[]}}Zu(e){return!this.Uu.has(e)&&!!this.Qu.has(e)&&!this.Qu.get(e).hasLocalMutations}Ju(e){e&&(e.addedDocuments.forEach(e=>this.Uu=this.Uu.add(e)),e.modifiedDocuments.forEach(e=>{}),e.removedDocuments.forEach(e=>this.Uu=this.Uu.delete(e)),this.current=e.current)}Yu(){if(!this.current)return[];let e=this.Ku;this.Ku=sa(),this.Qu.forEach(e=>{this.Zu(e.key)&&(this.Ku=this.Ku.add(e.key))});let t=[];return e.forEach(e=>{this.Ku.has(e)||t.push(new a5(e))}),this.Ku.forEach(n=>{e.has(n)||t.push(new a6(n))}),t}tc(e){this.Uu=e.Hi,this.Ku=sa();let t=this.Wu(e.documents);return this.applyChanges(t,!0)}ec(){return aX.fromInitialDocuments(this.query,this.Qu,this.mutatedKeys,0===this.qu,this.hasCachedResults)}}class a8{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class a7{constructor(e){this.key=e,this.nc=!1}}class oe{constructor(e,t,n,r,i,s){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.sc={},this.ic=new i5(e=>iI(e),i_),this.rc=new Map,this.oc=new Set,this.uc=new rb(rl.comparator),this.cc=new Map,this.ac=new sQ,this.hc={},this.lc=new Map,this.fc=s$.vn(),this.onlineState="Unknown",this.dc=void 0}get isPrimaryClient(){return!0===this.dc}}async function ot(e,t){let n=function(e){var t;let n=e;return n.remoteStore.remoteSyncer.applyRemoteEvent=os.bind(null,n),n.remoteStore.remoteSyncer.getRemoteKeysForTarget=ow.bind(null,n),n.remoteStore.remoteSyncer.rejectListen=oo.bind(null,n),n.sc.Wo=a1.bind(null,n.eventManager),n.sc.wc=a2.bind(null,n.eventManager),n}(e),r,i,s=n.ic.get(t);if(s)r=s.targetId,n.sharedClientState.addLocalQueryTarget(r),i=s.view.ec();else{let a=await function(e,t){var n;let r=e;return r.persistence.runTransaction("Allocate target","readwrite",e=>{let n;return r.Cs.getTargetData(e,t).next(i=>i?(n=i,rp.resolve(n)):r.Cs.allocateTargetId(e).next(i=>(n=new sU(t,i,0,e.currentSequenceNumber),r.Cs.addTargetData(e,n).next(()=>n))))}).then(e=>{let n=r.Ui.get(e.targetId);return(null===n||e.snapshotVersion.compareTo(n.snapshotVersion)>0)&&(r.Ui=r.Ui.insert(e.targetId,e),r.qi.set(t,e.targetId)),e})}(n.localStore,iw(t));n.isPrimaryClient&&ab(n.remoteStore,a);let o=n.sharedClientState.addLocalQueryTarget(a.targetId);i=await on(n,t,r=a.targetId,"current"===o,a.resumeToken)}return i}async function on(e,t,n,r,i){e._c=(t,n,r)=>(async function(e,t,n,r){let i=t.view.Wu(n);i.$i&&(i=await at(e.localStore,t.query,!1).then(({documents:e})=>t.view.Wu(e,i)));let s=r&&r.targetChanges.get(t.targetId),a=t.view.applyChanges(i,e.isPrimaryClient,s);return op(e,t.targetId,a.Xu),a.snapshot})(e,t,n,r);let s=await at(e.localStore,t,!0),a=new a9(t,s.Hi),o=a.Wu(s.documents),l=su.createSynthesizedTargetChangeForCurrentChange(n,r&&"Offline"!==e.onlineState,i),u=a.applyChanges(o,e.isPrimaryClient,l);op(e,n,u.Xu);let h=new a8(t,n,a);return e.ic.set(t,h),e.rc.has(n)?e.rc.get(n).push(t):e.rc.set(n,[t]),u.snapshot}async function or(e,t){var n;let r=e.ic.get(t),i=e.rc.get(r.targetId);if(i.length>1)return e.rc.set(r.targetId,i.filter(e=>!i_(e,t))),void e.ic.delete(t);e.isPrimaryClient?(e.sharedClientState.removeLocalQueryTarget(r.targetId),e.sharedClientState.isActiveQueryTarget(r.targetId)||await ae(e.localStore,r.targetId,!1).then(()=>{e.sharedClientState.clearQueryState(r.targetId),a_(e.remoteStore,r.targetId),od(e,r.targetId)}).catch(rf)):(od(e,r.targetId),await ae(e.localStore,r.targetId,!0))}async function oi(e,t,n){let r=function(e){var t;let n=e;return n.remoteStore.remoteSyncer.applySuccessfulWrite=ol.bind(null,n),n.remoteStore.remoteSyncer.rejectFailedWrite=ou.bind(null,n),n}(e);try{var i,s,a;let o=await function(e,t){var n;let r=rn.now(),i=t.reduce((e,t)=>e.add(t.key),sa()),s,a;return e.persistence.runTransaction("Locally write mutations","readwrite",n=>{let o=i9,l=sa();return e.Gi.getEntries(n,i).next(e=>{(o=e).forEach((e,t)=>{t.isValidDocument()||(l=l.add(e))})}).next(()=>e.localDocuments.getOverlayedDocuments(n,o)).next(i=>{s=i;let a=[];for(let o of t){let l=iQ(o,s.get(o.key).overlayedDocument);null!=l&&a.push(new iY(o.key,l,rZ(l.value.mapValue),i$.exists(!0)))}return e.mutationQueue.addMutationBatch(n,r,a,t)}).next(t=>{a=t;let r=t.applyToLocalDocumentSet(s,l);return e.documentOverlayCache.saveOverlays(n,t.batchId,r)})}).then(()=>({batchId:a.batchId,changes:se(s)}))}(r.localStore,t),l;r.sharedClientState.addPendingMutation(o.batchId),i=r,s=o.batchId,(l=i.hc[i.currentUser.toKey()])||(l=new rb(re)),l=l.insert(s,n),i.hc[i.currentUser.toKey()]=l,await oy(r,o.changes),await ax(r.remoteStore)}catch(h){let u=aG(h,"Failed to persist write");n.reject(u)}}async function os(e,t){var n;try{let r=await function(e,t){var n;let r=e,i=t.snapshotVersion,s=r.Ui;return r.persistence.runTransaction("Apply remote event","readwrite-primary",e=>{var n,a,o;let l=r.Gi.newChangeBuffer({trackRemovals:!0});s=r.Ui;let u=[];t.targetChanges.forEach((n,a)=>{var o,l,h;let c=s.get(a);if(!c)return;u.push(r.Cs.removeMatchingKeys(e,n.removedDocuments,a).next(()=>r.Cs.addMatchingKeys(e,n.addedDocuments,a)));let d=c.withSequenceNumber(e.currentSequenceNumber);t.targetMismatches.has(a)?d=d.withResumeToken(rk.EMPTY_BYTE_STRING,rr.min()).withLastLimboFreeSnapshotVersion(rr.min()):n.resumeToken.approximateByteSize()>0&&(d=d.withResumeToken(n.resumeToken,i)),s=s.insert(a,d),l=d,(0===c.resumeToken.approximateByteSize()||l.snapshotVersion.toMicroseconds()-c.snapshotVersion.toMicroseconds()>=3e8||n.addedDocuments.size+n.modifiedDocuments.size+n.removedDocuments.size>0)&&u.push(r.Cs.updateTargetData(e,d))});let h=i9,c=sa(),d,f;if(t.documentUpdates.forEach(n=>{t.resolvedLimboDocuments.has(n)&&u.push(r.persistence.referenceDelegate.updateLimboDocument(e,n))}),u.push((n=e,a=l,o=t.documentUpdates,d=sa(),f=sa(),o.forEach(e=>d=d.add(e)),a.getEntries(n,d).next(e=>{let t=i9;return o.forEach((n,r)=>{let i=e.get(n);r.isFoundDocument()!==i.isFoundDocument()&&(f=f.add(n)),r.isNoDocument()&&r.version.isEqual(rr.min())?(a.removeEntry(n,r.readTime),t=t.insert(n,r)):!i.isValidDocument()||r.version.compareTo(i.version)>0||0===r.version.compareTo(i.version)&&i.hasPendingWrites?(a.addEntry(r),t=t.insert(n,r)):nK("LocalStore","Ignoring outdated watch update for ",n,". Current version:",i.version," Watch version:",r.version)}),{Wi:t,zi:f}})).next(e=>{h=e.Wi,c=e.zi})),!i.isEqual(rr.min())){let p=r.Cs.getLastRemoteSnapshotVersion(e).next(t=>r.Cs.setTargetsMetadata(e,e.currentSequenceNumber,i));u.push(p)}return rp.waitFor(u).next(()=>l.apply(e)).next(()=>r.localDocuments.getLocalViewOfDocuments(e,h,c)).next(()=>h)}).then(e=>(r.Ui=s,e))}(e.localStore,t);t.targetChanges.forEach((t,n)=>{var r,i,s;let a=e.cc.get(n);a&&(t.addedDocuments.size+t.modifiedDocuments.size+t.removedDocuments.size<=1||nX(),t.addedDocuments.size>0?a.nc=!0:t.modifiedDocuments.size>0?(i=a.nc)||nX():t.removedDocuments.size>0&&(a.nc||nX(),a.nc=!1))}),await oy(e,r,t)}catch(i){await rf(i)}}function oa(e,t,n){var r;let i=e;if(i.isPrimaryClient&&0===n||!i.isPrimaryClient&&1===n){let s=[];i.ic.forEach((e,n)=>{let r=n.view.bu(t);r.snapshot&&s.push(r.snapshot)}),function(e,t){var n;let r=e;r.onlineState=t;let i=!1;r.queries.forEach((e,n)=>{for(let r of n.listeners)r.bu(t)&&(i=!0)}),i&&a4(r)}(i.eventManager,t),s.length&&i.sc.Wo(s),i.onlineState=t,i.isPrimaryClient&&i.sharedClientState.setOnlineState(t)}}async function oo(e,t,n){var r;let i=e;i.sharedClientState.updateQueryState(t,"rejected",n);let s=i.cc.get(t),a=s&&s.key;if(a){let o=new rb(rl.comparator);o=o.insert(a,r0.newNoDocument(a,rr.min()));let l=sa().add(a),u=new sl(rr.min(),new Map,new rT(re),o,l);await os(i,u),i.uc=i.uc.remove(a),i.cc.delete(t),om(i)}else await ae(i.localStore,t,!1).then(()=>od(i,t,n)).catch(rf)}async function ol(e,t){var n;let r=t.batch.batchId;try{let i=await function(e,t){var n;return e.persistence.runTransaction("Acknowledge batch","readwrite-primary",n=>{let r=t.batch.keys(),i=e.Gi.newChangeBuffer({trackRemovals:!0});return(function(e,t,n,r){let i=n.batch,s=i.keys(),a=rp.resolve();return s.forEach(e=>{a=a.next(()=>r.getEntry(t,e)).next(t=>{let s=n.docVersions.get(e);null!==s||nX(),0>t.version.compareTo(s)&&(i.applyToRemoteDocument(t,n),t.isValidDocument()&&(t.setReadTime(n.commitVersion),r.addEntry(t)))})}),a.next(()=>e.mutationQueue.removeMutationBatch(t,i))})(e,n,t,i).next(()=>i.apply(n)).next(()=>e.mutationQueue.performConsistencyCheck(n)).next(()=>e.documentOverlayCache.removeOverlaysForBatchId(n,r,t.batch.batchId)).next(()=>e.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,function(e){let t=sa();for(let n=0;n<e.mutationResults.length;++n)e.mutationResults[n].transformResults.length>0&&(t=t.add(e.batch.mutations[n].key));return t}(t))).next(()=>e.localDocuments.getDocuments(n,r))})}(e.localStore,t);oc(e,r,null),oh(e,r),e.sharedClientState.updateMutationState(r,"acknowledged"),await oy(e,i)}catch(s){await rf(s)}}async function ou(e,t,n){var r;try{let i=await function(e,t){var n;return e.persistence.runTransaction("Reject batch","readwrite-primary",n=>{let r;return e.mutationQueue.lookupMutationBatch(n,t).next(t=>(null!==t||nX(),r=t.keys(),e.mutationQueue.removeMutationBatch(n,t))).next(()=>e.mutationQueue.performConsistencyCheck(n)).next(()=>e.documentOverlayCache.removeOverlaysForBatchId(n,r,t)).next(()=>e.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,r)).next(()=>e.localDocuments.getDocuments(n,r))})}(e.localStore,t);oc(e,t,n),oh(e,t),e.sharedClientState.updateMutationState(t,"rejected",n),await oy(e,i)}catch(s){await rf(s)}}function oh(e,t){(e.lc.get(t)||[]).forEach(e=>{e.resolve()}),e.lc.delete(t)}function oc(e,t,n){var r;let i=e,s=i.hc[i.currentUser.toKey()];if(s){let a=s.get(t);a&&(n?a.reject(n):a.resolve(),s=s.remove(t)),i.hc[i.currentUser.toKey()]=s}}function od(e,t,n=null){for(let r of(e.sharedClientState.removeLocalQueryTarget(t),e.rc.get(t)))e.ic.delete(r),n&&e.sc.wc(r,n);e.rc.delete(t),e.isPrimaryClient&&e.ac.ls(t).forEach(t=>{e.ac.containsKey(t)||of(e,t)})}function of(e,t){e.oc.delete(t.path.canonicalString());let n=e.uc.get(t);null!==n&&(a_(e.remoteStore,n),e.uc=e.uc.remove(t),e.cc.delete(n),om(e))}function op(e,t,n){for(let r of n)r instanceof a6?(e.ac.addReference(r.key,t),og(e,r)):r instanceof a5?(nK("SyncEngine","Document no longer in limbo: "+r.key),e.ac.removeReference(r.key,t),e.ac.containsKey(r.key)||of(e,r.key)):nX()}function og(e,t){let n=t.key,r=n.path.canonicalString();e.uc.get(n)||e.oc.has(r)||(nK("SyncEngine","New document in limbo: "+n),e.oc.add(r),om(e))}function om(e){for(;e.oc.size>0&&e.uc.size<e.maxConcurrentLimboResolutions;){let t=e.oc.values().next().value;e.oc.delete(t);let n=new rl(rs.fromString(t)),r=e.fc.next();e.cc.set(r,new a7(n)),e.uc=e.uc.insert(n,r),ab(e.remoteStore,new sU(iw(id(n.path)),r,2,rm.at))}}async function oy(e,t,n){var r;let i=[],s=[],a=[];e.ic.isEmpty()||(e.ic.forEach((r,o)=>{a.push(e._c(o,t,n).then(t=>{if((t||n)&&e.isPrimaryClient&&e.sharedClientState.updateQueryState(o.targetId,(null==t?void 0:t.fromCache)?"not-current":"current"),t){i.push(t);let r=s3.Ci(o.targetId,t);s.push(r)}}))}),await Promise.all(a),e.sc.Wo(i),await async function(e,t){var n;let r=e;try{await r.persistence.runTransaction("notifyLocalViewChanges","readwrite",e=>rp.forEach(t,t=>rp.forEach(t.Si,n=>r.persistence.referenceDelegate.addReference(e,t.targetId,n)).next(()=>rp.forEach(t.Di,n=>r.persistence.referenceDelegate.removeReference(e,t.targetId,n)))))}catch(i){if(!rg(i))throw i;nK("LocalStore","Failed to update sequence numbers: "+i)}for(let s of t){let a=s.targetId;if(!s.fromCache){let o=r.Ui.get(a),l=o.snapshotVersion,u=o.withLastLimboFreeSnapshotVersion(l);r.Ui=r.Ui.insert(a,u)}}}(e.localStore,s))}async function ov(e,t){var n,r,i;let s=e;if(!s.currentUser.isEqual(t)){nK("SyncEngine","User change. New user:",t.toKey());let a=await s9(s.localStore,t);s.currentUser=t,i="'waitForPendingWrites' promise is rejected due to a user change.",(r=s).lc.forEach(e=>{e.forEach(e=>{e.reject(new nY(nJ.CANCELLED,i))})}),r.lc.clear(),s.sharedClientState.handleUserChange(t,a.removedBatchIds,a.addedBatchIds),await oy(s,a.ji)}}function ow(e,t){var n;let r=e.cc.get(t);if(r&&r.nc)return sa().add(r.key);{let i=sa(),s=e.rc.get(t);if(!s)return i;for(let a of s){let o=e.ic.get(a);i=i.unionWith(o.view.ju)}return i}}class ob{constructor(){this.synchronizeTabs=!1}async initialize(e){this.It=ah(e.databaseInfo.databaseId),this.sharedClientState=this.gc(e),this.persistence=this.yc(e),await this.persistence.start(),this.localStore=this.Ic(e),this.gcScheduler=this.Tc(e,this.localStore),this.indexBackfillerScheduler=this.Ec(e,this.localStore)}Tc(e,t){return null}Ec(e,t){return null}Ic(e){var t,n,r,i;return t=this.persistence,n=new s6,r=e.initialUser,i=this.It,new s5(t,n,r,i)}yc(e){return new s1(s4.Bs,this.It)}gc(e){return new ar}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class o_{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>oa(this.syncEngine,e,1),this.remoteStore.remoteSyncer.handleCredentialChange=ov.bind(null,this.syncEngine),await a$(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new aY}createDatastore(e){var t,n,r,i,s;let a=ah(e.databaseInfo.databaseId),o=(t=e.databaseInfo,new al(t));return n=e.authCredentials,r=e.appCheckCredentials,new ag(n,r,o,a)}createRemoteStore(e){var t,n,r,i,s;return t=this.localStore,n=this.datastore,r=e.asyncQueue,i=e=>oa(this.syncEngine,e,0),s=as.C()?new as:new ai,new ay(t,n,r,i,s)}createSyncEngine(e,t){return function(e,t,n,r,i,s,a){let o=new oe(e,t,n,r,i,s);return a&&(o.dc=!0),o}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}terminate(){return async function(e){var t;nK("RemoteStore","RemoteStore shutting down."),e._u.add(5),await aw(e),e.mu.shutdown(),e.gu.set("Unknown")}(this.remoteStore)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function oI(e,t,n){if(!n)throw new nY(nJ.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}function oT(e){if(!rl.isDocumentKey(e))throw new nY(nJ.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`)}function oE(e){if(rl.isDocumentKey(e))throw new nY(nJ.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`)}function oS(e){if(void 0===e)return"undefined";if(null===e)return"null";if("string"==typeof e)return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if("number"==typeof e||"boolean"==typeof e)return""+e;if("object"==typeof e){if(e instanceof Array)return"an array";{var t;let n=(t=e).constructor?t.constructor.name:null;return n?`a custom ${n} object`:"an object"}}return"function"==typeof e?"a function":nX()}function ok(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new nY(nJ.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{let n=oS(e);throw new nY(nJ.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${n}`)}}return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oN{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new oO(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new oN(this.firestore,e,this._key)}}class oD{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new oD(this.firestore,e,this._query)}}class oO extends oD{constructor(e,t,n){super(e,t,id(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){let e=this._path.popLast();return e.isEmpty()?null:new oN(this.firestore,null,new rl(e))}withConverter(e){return new oO(this.firestore,e,this._path)}}function ox(e,t,...n){if(e=(0,g.m9)(e),oI("collection","path",t),e instanceof oR){let r=rs.fromString(t,...n);return oE(r),new oO(e,null,r)}{if(!(e instanceof oN||e instanceof oO))throw new nY(nJ.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let i=e._path.child(rs.fromString(t,...n));return oE(i),new oO(e.firestore,null,i)}}function oL(e,t,...n){if(e=(0,g.m9)(e),1===arguments.length&&(t=n7.R()),oI("doc","path",t),e instanceof oR){let r=rs.fromString(t,...n);return oT(r),new oN(e,null,new rl(r))}{if(!(e instanceof oN||e instanceof oO))throw new nY(nJ.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let i=e._path.child(rs.fromString(t,...n));return oT(i),new oN(e.firestore,e instanceof oO?e.converter:null,new rl(i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oP{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Rc(this.observer.next,e)}error(e){this.observer.error?this.Rc(this.observer.error,e):nG("Uncaught Error in snapshot listener:",e)}bc(){this.muted=!0}Rc(e,t){this.muted||setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oM{constructor(e,t,n,r){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=n,this.databaseInfo=r,this.user=nq.UNAUTHENTICATED,this.clientId=n7.R(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this.authCredentials.start(n,async e=>{nK("FirestoreClient","Received user=",e.uid),await this.authCredentialListener(e),this.user=e}),this.appCheckCredentials.start(n,e=>(nK("FirestoreClient","Received new app check token=",e),this.appCheckCredentialListener(e,this.user)))}async getConfiguration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}verifyNotTerminated(){if(this.asyncQueue.isShuttingDown)throw new nY(nJ.FAILED_PRECONDITION,"The client has already been terminated.")}terminate(){this.asyncQueue.enterRestrictedMode();let e=new nZ;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this.onlineComponents&&await this.onlineComponents.terminate(),this.offlineComponents&&await this.offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(n){let t=aG(n,"Failed to shutdown persistence");e.reject(t)}}),e.promise}}async function oU(e,t){e.asyncQueue.verifyOperationInProgress(),nK("FirestoreClient","Initializing OfflineComponentProvider");let n=await e.getConfiguration();await t.initialize(n);let r=n.initialUser;e.setCredentialChangeListener(async e=>{r.isEqual(e)||(await s9(t.localStore,e),r=e)}),t.persistence.setDatabaseDeletedListener(()=>e.terminate()),e.offlineComponents=t}async function oF(e,t){e.asyncQueue.verifyOperationInProgress();let n=await oV(e);nK("FirestoreClient","Initializing OnlineComponentProvider");let r=await e.getConfiguration();await t.initialize(n,r),e.setCredentialChangeListener(e=>aq(t.remoteStore,e)),e.setAppCheckTokenChangeListener((e,n)=>aq(t.remoteStore,n)),e.onlineComponents=t}async function oV(e){return e.offlineComponents||(nK("FirestoreClient","Using default OfflineComponentProvider"),await oU(e,new ob)),e.offlineComponents}async function oj(e){return e.onlineComponents||(nK("FirestoreClient","Using default OnlineComponentProvider"),await oF(e,new o_)),e.onlineComponents}async function oB(e){let t=await oj(e),n=t.eventManager;return n.onListen=ot.bind(null,t.syncEngine),n.onUnlisten=or.bind(null,t.syncEngine),n}class oq{constructor(){this.Bc=Promise.resolve(),this.Lc=[],this.Uc=!1,this.qc=[],this.Kc=null,this.Gc=!1,this.Qc=!1,this.jc=[],this.xo=new ac(this,"async_queue_retry"),this.Wc=()=>{let e=au();e&&nK("AsyncQueue","Visibility state changed to "+e.visibilityState),this.xo.Po()};let e=au();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.Wc)}get isShuttingDown(){return this.Uc}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.zc(),this.Hc(e)}enterRestrictedMode(e){if(!this.Uc){this.Uc=!0,this.Qc=e||!1;let t=au();t&&"function"==typeof t.removeEventListener&&t.removeEventListener("visibilitychange",this.Wc)}}enqueue(e){if(this.zc(),this.Uc)return new Promise(()=>{});let t=new nZ;return this.Hc(()=>this.Uc&&this.Qc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise)).then(()=>t.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Lc.push(e),this.Jc()))}async Jc(){if(0!==this.Lc.length){try{await this.Lc[0](),this.Lc.shift(),this.xo.reset()}catch(e){if(!rg(e))throw e;nK("AsyncQueue","Operation failed with retryable error: "+e)}this.Lc.length>0&&this.xo.Ro(()=>this.Jc())}}Hc(e){let t=this.Bc.then(()=>(this.Gc=!0,e().catch(e=>{var t;this.Kc=e,this.Gc=!1;let n,r=(n=e.message||"",e.stack&&(n=e.stack.includes(e.message)?e.stack:e.message+"\n"+e.stack),n);throw nG("INTERNAL UNHANDLED ERROR: ",r),e}).then(e=>(this.Gc=!1,e))));return this.Bc=t,t}enqueueAfterDelay(e,t,n){this.zc(),this.jc.indexOf(e)>-1&&(t=0);let r=aK.createAndSchedule(this,e,t,n,e=>this.Yc(e));return this.qc.push(r),r}zc(){this.Kc&&nX()}verifyOperationInProgress(){}async Xc(){let e;do await (e=this.Bc);while(e!==this.Bc)}Zc(e){for(let t of this.qc)if(t.timerId===e)return!0;return!1}ta(e){return this.Xc().then(()=>{for(let t of(this.qc.sort((e,t)=>e.targetTimeMs-t.targetTimeMs),this.qc))if(t.skipDelay(),"all"!==e&&t.timerId===e)break;return this.Xc()})}ea(e){this.jc.push(e)}Yc(e){let t=this.qc.indexOf(e);this.qc.splice(t,1)}}function o$(e){return function(e,t){if("object"!=typeof e||null===e)return!1;for(let n of t)if(n in e&&"function"==typeof e[n])return!0;return!1}(e,["next","error","complete"])}class oz extends oR{constructor(e,t,n,r){super(e,t,n,r),this.type="firestore",this._queue=new oq,this._persistenceKey=(null==r?void 0:r.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||oG(this),this._firestoreClient.terminate()}}function oH(e,t){let n="object"==typeof e?e:(0,d.Mq)(),r=(0,d.qX)(n,"firestore").getImmediate({identifier:"string"==typeof e?e:t||"(default)"});if(!r._initialized){let i=(0,g.P0)("firestore");i&&function(e,t,n,r={}){var i;let s=(e=ok(e,oR))._getSettings();if("firestore.googleapis.com"!==s.host&&s.host!==t&&nW("Host has been set in both settings() and useEmulator(), emulator host will be used"),e._setSettings(Object.assign(Object.assign({},s),{host:`${t}:${n}`,ssl:!1})),r.mockUserToken){let a,o;if("string"==typeof r.mockUserToken)a=r.mockUserToken,o=nq.MOCK_USER;else{a=(0,g.Sg)(r.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);let l=r.mockUserToken.sub||r.mockUserToken.user_id;if(!l)throw new nY(nJ.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");o=new nq(l)}e._authCredentials=new n2(new n0(a,o))}}(r,...i)}return r}function oK(e){return e._firestoreClient||oG(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function oG(e){var t,n,r,i,s;let a=e._freezeSettings(),o=(n=e._databaseId,r=(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",i=e._persistenceKey,new rx(n,r,i,a.host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,a.useFetchStreams));e._firestoreClient=new oM(e._authCredentials,e._appCheckCredentials,e._queue,o)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oW{constructor(e){this._byteString=e}static fromBase64String(e){try{return new oW(rk.fromBase64String(e))}catch(t){throw new nY(nJ.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new oW(rk.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oQ{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new nY(nJ.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ro(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class oJ{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new nY(nJ.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new nY(nJ.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return re(this._lat,e._lat)||re(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ let oY=/^__.*__$/;class oZ{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new iY(e,this.data,this.fieldMask,t,this.fieldTransforms):new iJ(e,this.data,t,this.fieldTransforms)}}class o0{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new iY(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function o1(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw nX()}}class o2{constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.It=n,this.ignoreUndefinedProperties=r,void 0===i&&this.na(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get sa(){return this.settings.sa}ia(e){return new o2(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.It,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ra(e){var t;let n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.ia({path:n,oa:!1});return r.ua(e),r}ca(e){var t;let n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.ia({path:n,oa:!1});return r.na(),r}aa(e){return this.ia({path:void 0,oa:!0})}ha(e){return ls(e,this.settings.methodName,this.settings.la||!1,this.path,this.settings.fa)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}na(){if(this.path)for(let e=0;e<this.path.length;e++)this.ua(this.path.get(e))}ua(e){if(0===e.length)throw this.ha("Document fields must not be empty");if(o1(this.sa)&&oY.test(e))throw this.ha('Document fields cannot begin and end with "__"')}}class o4{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.It=n||ah(e)}da(e,t,n,r=!1){return new o2({sa:e,methodName:t,fa:n,path:ro.emptyPath(),oa:!1,la:r},this.databaseId,this.It,this.ignoreUndefinedProperties)}}function o3(e){let t=e._freezeSettings(),n=ah(e._databaseId);return new o4(e._databaseId,!!t.ignoreUndefinedProperties,n)}function o6(e,t,n,r,i,s={}){let a=e.da(s.merge||s.mergeFields?2:0,t,n,i);lt("Data must be an object, but it was:",a,r);let o=o7(r,a),l,u;if(s.merge)l=new rS(a.fieldMask),u=a.fieldTransforms;else if(s.mergeFields){let h=[];for(let c of s.mergeFields){let d=ln(t,c,n);if(!a.contains(d))throw new nY(nJ.INVALID_ARGUMENT,`Field '${d}' is specified in your field mask but missing from your input data.`);la(h,d)||h.push(d)}l=new rS(h),u=a.fieldTransforms.filter(e=>l.covers(e.field))}else l=null,u=a.fieldTransforms;return new oZ(new rY(o),l,u)}class o5 extends oX{_toFieldTransform(e){if(2!==e.sa)throw 1===e.sa?e.ha(`${this._methodName}() can only appear at the top level of your update data`):e.ha(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof o5}}class o9 extends oX{_toFieldTransform(e){return new iB(e.path,new ix)}isEqual(e){return e instanceof o9}}function o8(e,t){if(le(e=(0,g.m9)(e)))return lt("Unsupported field value:",t,e),o7(e,t);if(e instanceof oX)return function(e,t){if(!o1(t.sa))throw t.ha(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.ha(`${e._methodName}() is not currently supported inside arrays`);let n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.oa&&4!==t.sa)throw t.ha("Nested arrays are not supported");return function(e,t){let n=[],r=0;for(let i of e){let s=o8(i,t.aa(r));null==s&&(s={nullValue:"NULL_VALUE"}),n.push(s),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=(0,g.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e){var n,r,i;return n=t.It,"number"==typeof(r=e)&&Number.isInteger(r)&&!rM(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER?iA(r):iC(n,r)}if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let s=rn.fromDate(e);return{timestampValue:sb(t.It,s)}}if(e instanceof rn){let a=new rn(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:sb(t.It,a)}}if(e instanceof oJ)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof oW)return{bytesValue:s_(t.It,e._byteString)};if(e instanceof oN){let o=t.databaseId,l=e.firestore._databaseId;if(!l.isEqual(o))throw t.ha(`Document reference is for database ${l.projectId}/${l.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:sT(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.ha(`Unsupported field value: ${oS(e)}`)}(e,t)}function o7(e,t){let n={};return rw(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):rv(e,(e,r)=>{let i=o8(r,t.ra(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function le(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof rn||e instanceof oJ||e instanceof oW||e instanceof oN||e instanceof oX)}function lt(e,t,n){var r;if(!le(n)||"object"!=typeof n||null===n||Object.getPrototypeOf(n)!==Object.prototype&&null!==Object.getPrototypeOf(n)){let i=oS(n);throw"an object"===i?t.ha(e+" a custom object"):t.ha(e+" "+i)}}function ln(e,t,n){if((t=(0,g.m9)(t))instanceof oQ)return t._internalPath;if("string"==typeof t)return li(e,t);throw ls("Field path arguments must be of type string or ",e,!1,void 0,n)}let lr=RegExp("[~\\*/\\[\\]]");function li(e,t,n){if(t.search(lr)>=0)throw ls(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new oQ(...t.split("."))._internalPath}catch(r){throw ls(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function ls(e,t,n,r,i){let s=r&&!r.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;n&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${r}`),a&&(l+=` in document ${i}`),l+=")"),new nY(nJ.INVALID_ARGUMENT,o+e+l)}function la(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class lo{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new oN(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new ll(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(lu("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class ll extends lo{data(){return super.data()}}function lu(e,t){return"string"==typeof t?li(e,t):t instanceof oQ?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ class lw{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class lb extends lo{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new l_(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let n=this._document.data.field(lu("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class l_ extends lb{data(e={}){return super.data(e)}}class lI{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new lw(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new l_(this._firestore,this._userDataWriter,n.key,n,new lw(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new nY(nJ.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let n=0;return e._snapshot.docChanges.map(t=>{let r=new l_(e._firestore,e._userDataWriter,t.doc.key,t.doc,new lw(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);return t.doc,{type:"added",doc:r,oldIndex:-1,newIndex:n++}})}{let r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let n=new l_(e._firestore,e._userDataWriter,t.doc.key,t.doc,new lw(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(s=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return nX()}}(t.type),doc:n,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function lT(e){e=ok(e,oN);let t=ok(e.firestore,oz);return(function(e,t,n={}){let r=new nZ;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new oP({next(s){t.enqueueAndForget(()=>a0(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new nY(nJ.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new nY(nJ.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new a3(id(n.path),s,{includeMetadataChanges:!0,Nu:!0});return aZ(e,a)})(await oB(e),e.asyncQueue,t,n,r)),r.promise})(oK(t),e._key).then(n=>lD(t,e,n))}class lE extends ly{constructor(e){super(),this.firestore=e}convertBytes(e){return new oW(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new oN(this.firestore,null,t)}}function lS(e){e=ok(e,oD);let t=ok(e.firestore,oz),n=oK(t),r=new lE(t);return lh(e._query),(function(e,t,n={}){let r=new nZ;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new oP({next(n){t.enqueueAndForget(()=>a0(e,a)),n.fromCache&&"server"===r.source?i.reject(new nY(nJ.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new a3(n,s,{includeMetadataChanges:!0,Nu:!0});return aZ(e,a)})(await oB(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new lI(t,r,e,n))}function lk(e,t,n){e=ok(e,oN);let r=ok(e.firestore,oz),i=lv(e.converter,t,n);return lN(r,[o6(o3(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,i$.none())])}function lC(e,t,n,...r){e=ok(e,oN);let i=ok(e.firestore,oz),s=o3(i),a;return a="string"==typeof(t=(0,g.m9)(t))||t instanceof oQ?function(e,t,n,r,i,s){let a=e.da(1,t,n),o=[ln(t,r,n)],l=[i];if(s.length%2!=0)throw new nY(nJ.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let u=0;u<s.length;u+=2)o.push(ln(t,s[u])),l.push(s[u+1]);let h=[],c=rY.empty();for(let d=o.length-1;d>=0;--d)if(!la(h,o[d])){let f=o[d],p=l[d];p=(0,g.m9)(p);let m=a.ca(f);if(p instanceof o5)h.push(f);else{let y=o8(p,m);null!=y&&(h.push(f),c.set(f,y))}}let v=new rS(h);return new o0(c,v,a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.da(1,t,n);lt("Data must be an object, but it was:",i,r);let s=[],a=rY.empty();rv(r,(e,r)=>{let o=li(t,e,n);r=(0,g.m9)(r);let l=i.ca(o);if(r instanceof o5)s.push(o);else{let u=o8(r,l);null!=u&&(s.push(o),a.set(o,u))}});let o=new rS(s);return new o0(a,o,i.fieldTransforms)}(s,"updateDoc",e._key,t),lN(i,[a.toMutation(e._key,i$.exists(!0))])}function lA(e,t){let n=ok(e.firestore,oz),r=oL(e),i=lv(e.converter,t);return lN(n,[o6(o3(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,i$.exists(!1))]).then(()=>r)}function lR(e,...t){var n,r,i;e=(0,g.m9)(e);let s={includeMetadataChanges:!1},a=0;"object"!=typeof t[a]||o$(t[a])||(s=t[a],a++);let o={includeMetadataChanges:s.includeMetadataChanges};if(o$(t[a])){let l=t[a];t[a]=null===(n=l.next)||void 0===n?void 0:n.bind(l),t[a+1]=null===(r=l.error)||void 0===r?void 0:r.bind(l),t[a+2]=null===(i=l.complete)||void 0===i?void 0:i.bind(l)}let u,h,c;if(e instanceof oN)h=ok(e.firestore,oz),c=id(e._key.path),u={next(n){t[a]&&t[a](lD(h,e,n))},error:t[a+1],complete:t[a+2]};else{let d=ok(e,oD);h=ok(d.firestore,oz),c=d._query;let f=new lE(h);u={next(e){t[a]&&t[a](new lI(h,f,d,e))},error:t[a+1],complete:t[a+2]},lh(e._query)}return function(e,t,n,r){let i=new oP(r),s=new a3(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>aZ(await oB(e),s)),()=>{i.bc(),e.asyncQueue.enqueueAndForget(async()=>a0(await oB(e),s))}}(oK(h),c,o,u)}function lN(e,t){return function(e,t){let n=new nZ;return e.asyncQueue.enqueueAndForget(async()=>{var r;return oi(await oj(e).then(e=>e.syncEngine),t,n)}),n.promise}(oK(e),t)}function lD(e,t,n){let r=n.docs.get(t._key),i=new lE(e);return new lb(e,i,t._key,r,new lw(n.hasPendingWrites,n.fromCache),t.converter)}function lO(){return new o9("serverTimestamp")}!function(e,t=!0){var n;n$=d.Jn,(0,d.Xd)(new f.wA("firestore",(e,{instanceIdentifier:n,options:r})=>{let i=e.getProvider("app").getImmediate(),s=new oz(new n4(e.getProvider("auth-internal")),new n9(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new nY(nJ.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new rL(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,d.KN)(nB,"3.7.2",void 0),(0,d.KN)(nB,"3.7.2","esm2017")}()},774:function(e,t,n){"use strict";n.d(t,{Jt:function(){return et},cF:function(){return er},iH:function(){return en},sf:function(){return ee}});var r,i,s=n(5816),a=n(4444),o=n(8463);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(r)),(0,s.KN)(tH,tK,"esm2017")},6257:function(e,t,n){"use strict";n.d(t,{Bt:function(){return r.Bt},ET:function(){return r.ET},IO:function(){return r.IO},JU:function(){return r.JU},PL:function(){return r.PL},QT:function(){return r.QT},ad:function(){return r.ad},ar:function(){return r.ar},hJ:function(){return r.hJ},pl:function(){return r.pl},r7:function(){return r.r7}});var r=n(1294)},3454:function(e,t,n){"use strict";var r,i;e.exports=(null==(r=n.g.process)?void 0:r.env)&&"object"==typeof(null==(i=n.g.process)?void 0:i.env)?n.g.process:n(7663)},6840:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/_app",function(){return n(6723)}])},2676:function(e,t,n){"use strict";n.d(t,{I8:function(){return c},db:function(){return h},Ap:function(){return u},tO:function(){return l}});var r=n(5816);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
